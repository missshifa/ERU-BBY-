...
a("~বস আলভি এর ভালোবাসা নাও প্রিয়~");
...
setTimeout(() => {a({body: "‎༉༎༉😽!!লাইন টা তোমার জন্য  ডুবেছি আমি তোমার প্রেমের অনন্ত মায়ায় 🙈 ༅༎•❤️🌸🐰" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "‎দিন শেষে আমার তোমাকেই লাগবে😽!" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "~🖤এক আকাশ সমান স্বপ্ন নিয়ে তোমাকে ভালোবাসি প্রিয়🐰🦋🥰" + " " + name, mentions: arraytag})}, 12000);
...
setTimeout(() => {a({body: " যেদিন তুমি সব কিছু বুঝতে পারবে - সেদিন আমি সিমান্ত থাকবো না! 🙂🌸 ALVI PROJECT বট🤝" + " " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a({body: "︵🦋シ-𝐃𝐨𝐧'𝐭 𝐂𝐫𝐲 𝐅𝐨𝐫 𝐒𝐨𝐦𝐞𝐨𝐧𝐞..!😇🙂-  𝘁𝗵𝗶𝘀 𝗮𝗯𝗼𝘂𝘁 𝗹𝗶𝗻𝗲 🐰✨ দিন শেষে আমি আমার  তোমাকেই লাগবে😊🦋︵🦋❤️‍🩹" + " " + name, mentions: arraytag})},29000);
  ...
  setTimeout(() => {a({body: "যার জন্য সব কিছু  ছেড়ে আমি শূন্য 🙂💔🥀 আজ সে অন্য কাউকে নিয়ে পরিপূর্ণ  😔💔🥀" + name, mentions: arraytag})},62000);
